...
class _toprecommendedservicesState extends State<toprecommendedservices> {
  Servicefirebase wash_service = new Servicefirebase(
      ...
      category: "Car Wash",
      description: "Give your car a sparkling clean with our exterior foam wash and interior cleaning",
      discount: 0,
      name: "Exterior Wash",
  ...
  Servicefirebase ceramic_service = new Servicefirebase(
      ...
      category: "Detailing",
      description: "Enhance your vehicle’s shine and protection with our ceramic coating service. This high-tech coating creates a durable, hydrophobic layer that repels water and contaminants, making your car easier to clean and maintain.",
      discount: 0,
      name: "Ceramic Coat",
