...
class SubscriptionBookingDetailPage extends StatefulWidget {
  @override
  State<SubscriptionBookingDetailPage> createState() =>
      _SubscriptionBookingDetailPageState();
}

class _SubscriptionBookingDetailPageState
    extends State<SubscriptionBookingDetailPage> {
  ...
  Future<void> _refreshBookings() async {
    // Call the BookingController's fetch function
    await bookingController.fetchBookingsWithSubscriptionDetails();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final String carType =
        bookingController.subsBookingList[0]['car_details']?.split(';').first;
    log('car is : ${carType}');
  ...
  void _showBottomSheet(BuildContext context, String title, DateTime startDate,
      double startTime, double endTime, Map<String, dynamic> benefit, int idx) {
